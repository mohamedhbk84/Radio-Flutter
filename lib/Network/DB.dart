...
import 'package:radio/Network/Db.server.dart';
import 'package:radio/Network/Http/Web_Server.dart';
...
class DBDownloadService {
  ...
  static Future<RadioAPIModel> fetchAllRadios() async {
    final serviceResponse =
        await WebService().getData(Config.apiURL, new RadioAPIModel());
    return serviceResponse;
  }

  // static Future<RadioAPIModel> fetchAllRadios1() async {
  //   final serviceResponse =
  //       await WebService().getData(Config.apiURL1, new RadioAPIModel());
  //   return serviceResponse;
  // }
